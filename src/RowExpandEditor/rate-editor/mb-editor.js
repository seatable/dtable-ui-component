...
class RowExpandMBRateEditor extends React.Component {
    ...
    for (let i = 0; i < rate_max_number; i++) {
      ...
      const rateItem = (
        <div
          ...
          style={style}
          className={classnames('dtable-ui-mobile-row-expand-rate-item', { 'rate-item-active': value >= rateItemIndex })}
        >
  ...
  render() {
    ...
    return (
      <div className="dtable-ui-mobile-row-expand-rate-editor dtable-ui dtable-ui-row-expand-rate-editor">
        {rateList}
      </div>
    );
  }
...
RowExpandMBRateEditor.propTypes = {
...
export default RowExpandMBRateEditor;
