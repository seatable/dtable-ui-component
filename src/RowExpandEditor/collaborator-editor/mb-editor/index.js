...
class RowExpandMBCollaboratorEditor extends React.Component {
  ...
  render() {
    ...
    return (
      <>
        <div className="dtable-ui dtable-ui-mobile-row-expand-collaborators position-relative" onClick={this.openEditor}>
...
RowExpandMBCollaboratorEditor.propTypes = {
...
export default RowExpandMBCollaboratorEditor;
