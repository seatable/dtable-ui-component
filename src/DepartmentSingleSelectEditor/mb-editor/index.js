...
const MBDepartmentSingleSelectEditor = ({
  value: oldValue,
  column,
  ...
  const renderDepartments = useCallback(() => {
    ...
    return (
      <List className="my-list dtable-ui-mobile-department-editor-departments" renderHeader={() => getLocale('Select_department')}>
  ...
  return (
    <MobileFullScreenPage className="dtable-ui-mobile-department-editor" onClose={onClose}>
      <Header onLeftClick={onLeftClick} onRightClick={onSave} >
        <>{renderLeftContent()}</>
        <>{column.name}</>
...
MBDepartmentSingleSelectEditor.propTypes = {
  value: PropTypes.string,
  column: PropTypes.object,
  isSupportMultiple: PropTypes.bool,
  isFilterEditor: PropTypes.bool,
...
export default MBDepartmentSingleSelectEditor;
