...
import Select from '../../DTableCustomizeSelect';
...
import {
  getFilterByColumn, getUpdatedFilterBySelectSingle, getUpdatedFilterBySelectMultiple, isCheckboxColumn,
...
class FilterItem extends React.Component {
  ...
  renderFilterTerm = (filterColumn) => {
    const { index, filter, collaborators, anonymous } = this.props;
    ...
    switch (type) {
      ...
      case CellType.LAST_MODIFIER: {
        ...
        const creators = anonymous ? collaborators.concat([ anonymous ]) : collaborators;
        return (
          <CollaboratorFilter
            filterIndex={index}
            filterTerm={filter_term || []}
