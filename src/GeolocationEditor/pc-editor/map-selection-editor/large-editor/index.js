...
import { MAP_TYPES, getInitCenter, loadMapSource, getMapInfo, locateCurrentPosition } from '../../../map-editor-utils';
...
class LargeMapSelectionEditorDialog extends React.Component {
  ...
  renderBaiduMap = () => {
    this.setState({ isLoading: false }, () => {
      ...
      this.map = new window.BMap.Map('geolocation-map-selection-container-large', { enableMapClick: false });
  ...
  getInitValue = () => {
    ...
    if (!value || isEmptyObject(value)) {
      return { address: '', title: '', tag: '', point: {} };
    }
    return value;
  };
  ...
  render() {
    ...
    return (
      ...
      >
        ...
        <div className='dtable-ui-geolocation-map-editor-large selection-editor-large' onClick={this.handlerClick}>
          {!this.readOnly &&
          ...
          <div className={this.readOnly ? 'geolocation-map-read-only-container' : 'geolocation-map-container-large'}>
            ...
            {(!isLoading && this.mapType) && <div className='w-100 h-100' ref={ref => this.ref = ref} id="geolocation-map-selection-container-large"></div>}
          </div>
...
LargeMapSelectionEditorDialog.propTypes = propTypes;
