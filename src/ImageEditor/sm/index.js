...
const Small = ({ value: oldValue, column, config, onToggle, onCommit, uploadFile }) => {
  ...
  return (
    <MobileFullScreenPage onLeftClick={onToggle} onClose={onToggle} className="mobile-dtable-ui-image-editor" >
