...
const MobileSelectorEditor = ({
  ...
  return (
    <MobileModal onClose={onClose} className={className}>
      <List renderHeader={renderHeader} className={classnames('popup-list mobile-dtable-ui-selector-editor', listClassName)}>
        {children}
      </List>
    </MobileModal>
  );
...
MobileSelectorEditor.propTypes = {
...
MobileSelectorEditor.Search = Search;
MobileSelectorEditor.Option = Option;
MobileSelectorEditor.Options = Options;
MobileSelectorEditor.Empty = Empty;

export default MobileSelectorEditor;
