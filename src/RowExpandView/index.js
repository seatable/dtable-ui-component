...
const { Header, Body: MobileFullScreenPageBody } = MobileFullScreenPage;

const RowExpandView = forwardRef(({
  ...
  return (
    <MobileFullScreenPage
      className={classnames('dtable-ui-mobile-row-expand-full-screen-page', className)}
      zIndex={zIndex || 100}
