...
class Body extends React.Component {
  ...
  renderColumnValue = (row, column) => {
    ...
    return (
      <RowExpandFormatter
        {...props}
        className={classnames('mobile-dtable-ui-row-expand-formatter', `mobile-dtable-row-expand-${column.type}-formatter`, className)}
        column={column}
        row={row}
        component={formatter}
  ...
  render() {
    ...
    return (
      <div className="dtable-ui-row-expand-body mobile-dtable-ui-row-expand-body">
