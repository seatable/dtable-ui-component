...
class MBSelectEditor extends React.Component {
  ...
  render() {
    ...
    return (
      <MobileSelector onClose={this.props.onClose} title={column.name} className="dtable-ui-mobile-select-editor" >
        {options.length > 10 && (
