  ...
  function renderDepartments() {
    ...
    return (
      <div
        ...
        className={`dropdown-menu show departments-container ${classNamePrefix}`}
      >
        {isShowSelectedDepartments && 
          <div className="selected-departments" onClick={onClick}>
            <SelectedDepartments
              value={value}
...
DepartmentMultipleSelect.propTypes = propTypes;
